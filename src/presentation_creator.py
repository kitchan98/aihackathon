...
class PresentationCreator:
    ...
    def __init__(self) -> None:
        ...
        self.prs = Presentation(source_stream)
    ...
    def convert_presentation_to_image(self, file_name: str, directory_name) -> List:
        ...
        return [x.filename for x in convert_from_path(pdf_path, output_folder=directory_name, fmt="png")]
...
if __name__ == "__main__":
    ...
    img_paths = presentation_creator.convert_presentation_to_image("sample_presentation.pptx", "presentation_images")
