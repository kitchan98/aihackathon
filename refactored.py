...
class PresentationCreator:
    ...
    def add_picture_caption_layout(self, slide_info: dict) -> None:
        ...
        title_shape.text_frame.paragraphs[0].font.size = Inches(.45)
    ...
    def add_table_layout(self, slide_info: dict, table_data: dict) -> None:
        ...
        title_shape = slide.shapes.title
        title_shape.text = slide_info["title"]
        title_shape.left = Inches(.75)  # Adjust left position as needed
        ...
        table = slide.shapes.add_table(len(table_data['rows']) + 1, len(table_data['header']), left, top, width, height).table
