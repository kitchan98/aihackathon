...
def convert_image():
    with open(
        "/Users/shubhamjain/personal/aihackathon/aihackathon/streamlit/images/image1.png",
        "rb",
    ) as image_file:
...
def main():
    ...
    if getattr(st.session_state, "loading_complete", False):
        ...
        button_pressed = None
        button_a = click_detector(
            f"<a href='#' id='Template1'><img width='20%' src='data:image/png;base64,  {convert_image()}'></a>"
        )
        button_b = click_detector(
            "<a href='#' id='Template2'><img width='20%' src='https://images.unsplash.com/photo-1565130838609-c3a86655db61?w=200'></a>"
        )
        button_c = click_detector(
            "<a href='#' id='Template3'><img width='20%' src='https://images.unsplash.com/photo-1565130838609-c3a86655db61?w=200'></a>"
        )
